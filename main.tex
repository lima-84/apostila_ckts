...
Componentes passivos não conseguem, por si só, gerar e/ou manipular sinais. Quando combinados com elementos ativos, no entanto, permitem a implementação de diversos sistemas analógicos. O sentido da corrente nos passivos é sempre dadd de modo que o fluxo passe do terminal positivo para o negativo. Alternativamente, a polarização da tensão sempre terá seu terminal positivo definido pelo ponto em que a corrente ``entra''. Alguns exemplos são os resistores, os capacitores, e os indutores.
...
\noindent\textbf{\small{\textbullet} Configuração Paralelo-Paralelo:}
...
\noindent\textbf{\small{\textbullet}Configuração Série-Paralelo:}
...
\noindent\textbf{\small{\textbullet}Configuração Paralelo-Série:}
...
\noindent\textbf{\small{\textbullet}Configuração Cascata:}
...
\noindent\textbf{\small{\textbullet} Caso 2:} $\lambda_{1} = \lambda_{2} = \lambda, \quad \lambda_{1},\lambda_{2} \in \mathbb{R}$ \\
...
\noindent\textbf{\small{\textbullet} Caso 3:} $\lambda_{1} = \overline{\lambda_{2}}, \quad \lambda_{1},\lambda_{2} \in \mathbb{C}$ \\
