...
\begin{equation}
    e_o = R_2\left[\dfrac{e_i-e_o}{R_1}-C_1 \deo{}\right] + \dfrac{1}{C_2} \int \left[\dfrac{e_i-e_o}{R_1} - C_1 \deo{} dt\right] \label{eq:ex_dif_int}.
\end{equation}
...
\begin{equation*}
    \dfrac{de_o}{dt} = R_2\left[\dfrac{1}{R_1}\dfrac{de_i}{dt}-\dfrac{1}{R_1}\dfrac{de_o}{dt}-C_1 \dfrac{d^2e_o}{dt^2}\right] + \dfrac{1}{C_2}\left[\dfrac{e_i-e_o}{R_1} - C_1 \dfrac{de_o}{dt}\right].
\end{equation*}
